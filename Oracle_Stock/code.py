...
df = pd.read_csv('Oracle_Stock/oracle.csv', delimiter=',')
...
summary_stats.to_csv(f"{OUTPUT_DIR}/ORCL_summary_stats.csv", index=False)
weekday_avg.to_csv(f"{OUTPUT_DIR}/ORCL_weekday_avg_return.csv")
month_avg.to_csv(f"{OUTPUT_DIR}/ORCL_month_avg_return.csv")
importance.to_csv(f"{OUTPUT_DIR}/ORCL_feature_importance.csv")
anomaly_table.to_csv(f"{OUTPUT_DIR}/ORCL_anomaly_days.csv", index=False)

fig = plt.figure(figsize=(20, 22))
fig.suptitle("Oracle (ORCL) - Full Research Summary", fontsize=18, fontweight="bold")
...
plt.savefig(f"{OUTPUT_DIR}/ORCL_all_charts.png", dpi=120)
plt.show()
